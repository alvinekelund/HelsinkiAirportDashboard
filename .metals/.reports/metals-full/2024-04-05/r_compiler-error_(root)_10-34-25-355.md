...
parent      = new HBox(
  hCURSORnew ComboBox (List("Graph View", "Metric View")) viewComboBox null) # -1,
parent span = <7414..14194>,
child       = hCURSORnew ComboBox (List("Graph View", "Metric View")) viewComboBox null # -1,
child span  = [7423..7484..14200]
...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    def initializeGraph(): VBox = {
      ...
      val viewComboBox = new HBox(h@@new ComboBox(List("Graph View", "Metric View"))
