...
parent      = new HBox(hideButton,
  new ComboBox(List("Graph View", "Metric View")) viewComboBox null) # -1,
parent span = <7414..14199>,
child       = new ComboBox(List("Graph View", "Metric View")) viewComboBox null # -1,
child span  = [7435..7489..14205]
...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    def initializeGraph(): VBox = {
      ...
      val viewComboBox = new HBox(hideButton, new ComboBox(List("Graph View", "Metric View"))
