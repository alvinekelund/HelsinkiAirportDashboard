...
parent      = new HBox(hidnew ComboBox (List("Graph View", "Metric View")) viewComboBox null) # -1,
parent span = <7414..14190>,
child       = hidnew ComboBox (List("Graph View", "Metric View")) viewComboBox null # -1,
child span  = [7423..7480..14196]
...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    def initializeGraph(): VBox = {
      ...
      val viewComboBox = new HBox(hidnew ComboBox(List("Graph View", "Metric View"))
