...
parent      = new HBox(
  hideButtonew ComboBox (List("Graph View", "Metric View")) viewComboBox null) # -1,
parent span = <7414..14196>,
child       = hideButtonew ComboBox (List("Graph View", "Metric View")) viewComboBox null # -1,
child span  = [7423..7486..14202]
...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    def initializeGraph(): VBox = {
      ...
      val viewComboBox = new HBox(hideButtonew ComboBox(List("Graph View", "Metric View"))
