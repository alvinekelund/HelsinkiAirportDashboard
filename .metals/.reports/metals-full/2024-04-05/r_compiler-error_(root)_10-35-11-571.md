...
parent      = new HBox(hCURSORviewComboBox border null) # -1,
parent span = <9399..14194>,
child       = hCURSORviewComboBox border null # -1,
child span  = [9408..9434..14200]
...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    */
      ...
      border.right = new HBox(h@@viewComboBox
