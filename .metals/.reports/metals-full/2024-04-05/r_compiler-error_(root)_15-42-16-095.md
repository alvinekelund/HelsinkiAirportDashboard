...
parent      = new VBox(addMetric(newestMetric) changeInfo null) # -1,
parent span = [10044..12532],
child       = addMetric(newestMetric) changeInfo null # -1,
child span  = [10053..10087..12538]
  ...
  def start() =
    ...
    def initializeGraph(): VBox = {
      ...
      def updateMetrics(): Unit =
          ...
          changeInfo = 0
          newCBoxes.children.clear()
          newCBoxes.children.addAll(datasetCom@@boBoxM, deparrComboBoxM, removeButton, addButton)
          visible = newMetric
