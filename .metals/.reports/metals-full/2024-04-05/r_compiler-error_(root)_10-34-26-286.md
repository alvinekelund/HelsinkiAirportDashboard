...
parent      = new HBox(hidernew ComboBox (List("Graph View", "Metric View")) viewComboBox null
  ) # -1,
parent span = <7414..14192>,
child       = hidernew ComboBox (List("Graph View", "Metric View")) viewComboBox null # -1,
child span  = [7423..7482..14198]
...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    def initializeGraph(): VBox = {
      ...
      val viewComboBox = new HBox(hidernew ComboBox(List("Graph View", "Metric View"))
