...
parent      = new HBox(hideBnew ComboBox (List("Graph View", "Metric View")) viewComboBox null
  ) # -1,
parent span = <7414..14192>,
child       = hideBnew ComboBox (List("Graph View", "Metric View")) viewComboBox null # -1,
...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    def initializeGraph(): VBox = {
      ...
      val viewComboBox = new HBox(hideBnew ComboBox(List("Graph View", "Metric View"))
