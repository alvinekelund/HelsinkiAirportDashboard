...
parent      = new HBox(hidviewComboBox border null) # -1,
parent span = <9399..14190>,
child       = hidviewComboBox border null # -1,
child span  = [9408..9430..14196]
...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    */
      ...
      border.right = new HBox(hidviewComboBox
