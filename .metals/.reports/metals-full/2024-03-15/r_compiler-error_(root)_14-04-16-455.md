...
parent      = new ListView(List("doq", "oeja", "djaie") homeTab null) # -1,
parent span = <6136..6284>,
child       = List("doq", "oeja", "djaie") homeTab null # -1,
child span  = [6149..6183..6288]
...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    val border = new BorderPane
      border.left = chartVBox
      border.right = new ListView(List("doq", "oeja", "djaie")

    homeTab.content = border
