...
parent      = new VBox(List("Total Flights", "0") metric null) # -1,
parent span = <3061..7315>,
child       = List("Total Flights", "0") metric null # -1,
child span  = [3070..3101..7319]
...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    val metric = new VBox(List("Total Flights", "0")
    metric.visible = true
    metric.managed = true   
    ...
    split1.items.addAll(chartVBox1, metric)
    split.items.addAll(split1, chartVBox2)
