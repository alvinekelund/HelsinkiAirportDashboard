...
parent      = new LineChart(null) # -1,
parent span = <3269..3354>,
child       = null # -1,
child span  = [3283..3366..3366]
...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    def makeColumnGraph(graphDataType: Array[(String, Int)]): BarChart[String, Number] =
      val columnChart = new ColumnChart()
      val chart = columnChart.createColumnChart(graphDataType)
      chart
    
    def makeScatterChart(graphDataType: Array[(String, Int)]): ScatterChart[String, Number] = 
      val scatterChart = new ScatterPlot()
      val chart = scatterChart.createScatterChart(graphDataType)
      chart

    def makeLineChart(graphDataType: Array[(String, Int)]): LineChart[String, Number] = 
      val lineChart = new LineChart(@@
      val chart = lineChart.createLineChart(graphDataType)
      chart

    

    val graphData = new GraphData
    val chart = makeLineChart(graphData.flightPerHourData(getAllFlightData()))
