...
parent      = new HBox(deparrComboBox, viewComboBox HBox null) # -1,
parent span = <6304..8167>,
child       = viewComboBox HBox null # -1,
child span  = [6329..6348..8172]
...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    def initializeGraph(): VBox = {
      ...
      val comboBoxHBox2 = new HBox(deparrComboBox, viewComboBox
