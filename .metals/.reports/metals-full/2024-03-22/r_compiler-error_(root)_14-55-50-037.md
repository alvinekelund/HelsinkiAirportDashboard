...
parent      = new VBox(
  comcard.makeMetric(getMetricData(selectedDatasetM)._1,
    getMetricData(selectedDatasetM)._2) chartVBox null
) # -1,
parent span = <7412..7976>,
child       = comcard.makeMetric(getMetricData(selectedDatasetM)._1,
  getMetricData(selectedDatasetM)._2) chartVBox null # -1,
child span  = [7421..7537..7982]
    ...
    def initializeGraph(): VBox = {
      ...
      def updateChart(): Unit = 
          ...
          val newContent = selectedView match 
            ...
            case "Metric View" =>
              v = 1
              new VBox(comcard.makeMetric(getMetricData(selectedDatasetM)._1, getMetricData(selectedDatasetM)._2)
