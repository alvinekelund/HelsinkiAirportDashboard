    ...
    def initializeGraph(): VBox = {
      ...
      def updateChart(): Unit = 
          ...
          val newContent = selectedView match 
            ...
            case "Metric View" =>
              v = 1
              new VBox(comboBoxHBox2, @@card.makeMetric(getMetricData(selectedDatasetM)._1, getMetricData(selectedDatasetM)._2)
