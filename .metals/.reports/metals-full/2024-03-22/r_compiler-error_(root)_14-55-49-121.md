...
parent      = new VBox(
  cCURSORcard.makeMetric(getMetricData(selectedDatasetM)._1,
    getMetricData(selectedDatasetM)._2) chartVBox null
) # -1,
parent span = <7412..7980>,
child       = cCURSORcard.makeMetric(getMetricData(selectedDatasetM)._1,
  getMetricData(selectedDatasetM)._2) chartVBox null # -1,
child span  = [7421..7541..7986]
    ...
    def initializeGraph(): VBox = {
      ...
      def updateChart(): Unit = 
          ...
          val newContent = selectedView match 
            ...
            case "Metric View" =>
              v = 1
              new VBox(c@@card.makeMetric(getMetricData(selectedDatasetM)._1, getMetricData(selectedDatasetM)._2)
