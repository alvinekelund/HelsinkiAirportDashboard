    ...
    def initializeGraph(): VBox = {
      ...
      def updateChart(): Unit = 
          ...
          val newContent = selectedView match 
            case "Graph View" =>
              v = 0
              new VBox(makeChart(comboBoxHBox1, selectedGraph, getChartData(selectedDatasetC)._1, getChartData(selectedDatasetC)._2,
                getChartData(selectedDatasetC)._3, getChartData(selectedDatasetC)._4))
            case "Metric View" =>
              v = 1
              new VBox(card.makeM@@etric(getMetricData(selectedDatasetM)._1, getMetricData(selectedDatasetM)._2)
