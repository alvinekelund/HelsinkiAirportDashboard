...
parent      = new HBox(10, deparrComboBox, viewComboBox HBox null) # -1,
parent span = <6304..8171>,
child       = viewComboBox HBox null # -1,
child span  = [6333..6352..8176]
...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    def initializeGraph(): VBox = {
      ...
      val comboBoxHBox2 = new HBox(10, deparrComboBox, viewCom@@boBox
