...
parent      = new VBox(
  makeChart(selectedGraph, getChartData(selectedDatasetC)._1,
    getChartData(selectedDatasetC)._2, getChartData(selectedDatasetC)._3,
    getChartData(selectedDatasetC)._4) = null
) # -1,
parent span = <7138..7949>,
child       = makeChart(selectedGraph, getChartData(selectedDatasetC)._1,
  getChartData(selectedDatasetC)._2, getChartData(selectedDatasetC)._3,
  getChartData(selectedDatasetC)._4) = null # -1,
child span  = [7147..7327..7955]
    ...
    def initializeGraph(): VBox = {
      ...
      def updateChart(): Unit = 
          ...
          val newContent = selectedView match 
            ...
            case "Metric View" =>
              v = 1
              card.makeMetric(getMetricData(selectedDatasetM)._1, getMetricData(selectedDatasetM)._2)
