...
parent      =  extends JFXApp3.PrimartyStage {
  title = null
} # -1,
parent span = <615..662>,
child       = title = null # -1,
child span  = [648..654..668]
...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    stage = new JFXApp3.PrimartyStage:
      title = "Graph

    val vbox = new VBox(1@@0, new Button("Home"), new Button("Settings"))
    ...
    root.children += (button, comboBox, listView, menuBar)
