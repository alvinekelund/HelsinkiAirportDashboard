...
object Dashboard extends JFXApp3:
  ...
  def start() =
    ...
    val columnChart = BarChart[xAxis,@@]
    
    val series = new XYChart.Series[Number, String]()
    carrierCountArray.foreach { case (carrier, count) =>
      series.data() += XYChart.Data[Number, String](count, carrier)
    }

    val xAxis = new NumberAxis()
    val yAxis = new CategoryAxis()
    val columnChart = new BarChart[Number, String](xAxis, yAxis)
